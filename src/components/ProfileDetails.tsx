              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-10 ">
                ...
                <div className="flex items-center p-5  bg-[#FAFAFA] rounded-xl w-full h-auto">
                  ...
                  <div className="flex items-center gap-2 w-[60%]">
                    {profileImage ? (
                      <img src={profileImage.toString()} alt="Profile" className="rounded-xl mx-auto" width={180} height={180}/>
                    ) : (
                      <div className="rounded-xl bg-[#EFEBFF] pt-[61px] pb-[60px] pl-[39px] pr-[38px] flex items-center justify-center w-[65%] h-[193px]">
                        <label htmlFor="profileImage" className="flex flex-col items-center text-[#633CFF] cursor-pointer">
